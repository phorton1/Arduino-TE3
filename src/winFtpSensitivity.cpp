...
void winFtpSensitivity::updateUI()	// draw
{
	...
	if (full_draw)
	{
	    ...
	    tft.setCursor(SENS_LEFT + 190,SENS_BOTTOM + 8);
		tft.print("Dyn Range");
	    tft.setCursor(SENS_LEFT + 190,SENS_BOTTOM + 3 + SENS_ROW_Y_OFFSET);
		tft.print("Dyn Offset");

	    tft.setCursor(SENS_LEFT,SENS_BOTTOM + 8);
		tft.print("Touch Sens");
	}
