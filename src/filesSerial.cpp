...
void handleFileSystemChar(bool is_serial, char c)
	// externed for TE2
{
...
void checkFileCommandTimeout()
	// broke out into method for TE2
{
	for (int i=0; i<2; i++)
	{
