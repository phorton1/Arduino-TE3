...
//----------------------------------------------------------------
// prototype API
//      not sure that a polling approach is best for clients
//          but that's what exists at this time in this API
//      need to implement button presses and debouncing in the process() method
//          but I'm not sure what the API should look like (callbacks, etc)
